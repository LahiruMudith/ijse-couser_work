...
//
//public class Work {
//    String[][] loginDetails = {{"Lahiru","1212"}};
//}
//
...
//}
//
////    public static void updateSupplier(Scanner scan, String[][] supplierDetails) {
////        System.out.println("+---------------------------------------------------------------------+");
...
//            for (String sId : supplierDetails[i][0].split(",")) {
...
//            supplierDetails[i][1] = scan.next();
//            supplierDetails[i][0] = getSupplierId;
...
//    String[][] supplierDetails = new String[1][2];
...
//            case 1 : {
//                clearConsole();
//                supplierDetails = addSupplier(scan, supplierDetails);
//                break;
//            }
//            case 2 : {
//                clearConsole();
